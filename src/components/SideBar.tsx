...
import { IconMap, IconTasks, IconContacts, IconMessages, IconJournal, IconRadio, IconStats } from './Icons'
...
export function SideBar() {
  ...
  return (
    <aside className="w-[68px] shrink-0 flex flex-col border-r border-pda-border bg-pda-frame">
        ...
        return (
          <button
            ...
            className={`relative flex flex-col items-center justify-center gap-1 py-3
              text-[10px] tracking-[0.15em] uppercase border-b border-pda-border
              transition-colors
              ${active
          ...
          >
            ...
            {badge !== null && (
              <span className="absolute top-1 right-2 bg-pda-orange text-black text-[9px] px-1 leading-3 font-bold">
                {badge}
              </span>
            )}
          </button>
